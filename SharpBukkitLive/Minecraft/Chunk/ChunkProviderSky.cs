...
namespace net.minecraft.src
{
	public class ChunkProviderSky : net.minecraft.src.IChunkProvider
	{
		...
		{
			double d = 0.03125D;
			field_28077_r = field_28081_n.GenerateNoiseOctaves(field_28077_r, i * 16, j * 16, 
				0.0D, 16, 16, 1, d, d, 1.0D);
			field_28076_s = field_28081_n.GenerateNoiseOctaves(field_28076_s, i * 16, 109.0134D
				, j * 16, 16, 1, 16, d, 1.0D, d);
			field_28075_t = field_28080_o.GenerateNoiseOctaves(field_28075_t, i * 16, j * 16, 
				0.0D, 16, 16, 1, d * 2D, d * 2D, d * 2D);
			for (int k = 0; k < 16; k++)
			{
				for (int l = 0; l < 16; l++)
				{
			 ...
			 j1)
		{
			...
			field_28088_g = field_28094_a.Func_4103_a(field_28088_g, i, k, l, j1, 1.121D, 1.121D
				, 0.5D);
			field_28087_h = field_28093_b.Func_4103_a(field_28087_h, i, k, l, j1, 200D, 200D, 
				0.5D);
			d *= 2D;
			field_28091_d = field_28082_m.GenerateNoiseOctaves(field_28091_d, i, j, k, l, i1, 
				j1, d / 80D, d1 / 160D, d / 80D);
			field_28090_e = field_28084_k.GenerateNoiseOctaves(field_28090_e, i, j, k, l, i1, 
				j1, d, d1, d);
			field_28089_f = field_28083_l.GenerateNoiseOctaves(field_28089_f, i, j, k, l, i1, 
				j1, d, d1, d);
			int k1 = 0;
			int l1 = 0;
			int i2 = 16 / l;

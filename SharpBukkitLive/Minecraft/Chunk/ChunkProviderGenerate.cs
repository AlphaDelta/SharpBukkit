...
namespace net.minecraft.src
{
    public class ChunkProviderGenerate : net.minecraft.src.IChunkProvider
    {
             ...
             j1)
        {
            ...
            tasks[0] = Task.Run(() => { field_4226_g = field_715_a.Func_4103_a(field_4226_g, i, k, l, j1, 1.121D, 1.121D, 0.5D); });
            tasks[1] = Task.Run(() => { field_4225_h = field_714_b.Func_4103_a(field_4225_h, i, k, l, j1, 200D, 200D, 0.5D); });
            tasks[2] = Task.Run(() => { field_4229_d = field_703_m.GenerateNoiseOctaves(field_4229_d, i, j, k, l, i1, j1, d / 80D, d1 / 160D, d / 80D); });
            tasks[3] = Task.Run(() => { field_4228_e = field_705_k.GenerateNoiseOctaves(field_4228_e, i, j, k, l, i1, j1, d, d1, d); });
            tasks[4] = Task.Run(() => { field_4227_f = field_704_l.GenerateNoiseOctaves(field_4227_f, i, j, k, l, i1, j1, d, d1, d); });

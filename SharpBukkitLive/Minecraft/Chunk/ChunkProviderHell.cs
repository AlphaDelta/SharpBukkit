...
namespace net.minecraft.src
{
    public class ChunkProviderHell : net.minecraft.src.IChunkProvider
    {
             ...
             j1)
        {
            ...
            tasks[0] = Task.Run(() => { field_4243_f = field_4248_a.GenerateNoiseOctaves(field_4243_f, i, j, k, l, 1, j1, 1.0D, 0.0D, 1.0D); });
            tasks[1] = Task.Run(() => { field_4242_g = field_4247_b.GenerateNoiseOctaves(field_4242_g, i, j, k, l, 1, j1, 100D, 0.0D, 100D); });
            tasks[2] = Task.Run(() => { field_4246_c = field_4238_k.GenerateNoiseOctaves(field_4246_c, i, j, k, l, i1, j1, d / 80D, d1 / 60D, d / 80D); });
            tasks[3] = Task.Run(() => { field_4245_d = field_4240_i.GenerateNoiseOctaves(field_4245_d, i, j, k, l, i1, j1, d, d1, d); });
            tasks[4] = Task.Run(() => { field_4244_e = field_4239_j.GenerateNoiseOctaves(field_4244_e, i, j, k, l, i1, j1, d, d1, d); });

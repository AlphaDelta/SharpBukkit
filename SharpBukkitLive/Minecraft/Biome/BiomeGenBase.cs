...
namespace net.minecraft.src
{
	public class BiomeGenBase
	{
		protected internal BiomeGenBase()
		{
			...
			spawnableMonsterList = new System.Collections.ArrayList();
			spawnableCreatureList = new System.Collections.ArrayList();
			spawnableWaterCreatureList = new System.Collections.ArrayList();
			enableRain = true;
			spawnableMonsterList.Add(      new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntitySpider)), 10));
			spawnableMonsterList.Add(      new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntityZombie)), 10));
			spawnableMonsterList.Add(      new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntitySkeleton)), 10));
			spawnableMonsterList.Add(      new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntityCreeper)), 10));
			spawnableMonsterList.Add(      new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntitySlime)), 10));
			spawnableCreatureList.Add(     new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntitySheep)), 12));
			spawnableCreatureList.Add(     new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntityPig)), 10));
			spawnableCreatureList.Add(     new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntityChicken)), 10));
			spawnableCreatureList.Add(     new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntityCow)), 8));
			spawnableWaterCreatureList.Add(new net.minecraft.src.SpawnListEntry(Sharpen.Runtime.GetClassForType(typeof(net.minecraft.src.EntitySquid)), 10));
		}
		...
		public virtual System.Collections.IList GetSpawnableList(net.minecraft.src.EnumCreatureType
			 enumcreaturetype)
		{
		...
		protected internal System.Collections.IList spawnableMonsterList;

		protected internal System.Collections.IList spawnableCreatureList;

		protected internal System.Collections.IList spawnableWaterCreatureList;

...
namespace net.minecraft.src
{
    public class EmptyChunk : net.minecraft.src.Chunk
    {
        ...
        public override void GetEntitiesWithinAABBForEntity(net.minecraft.src.Entity entity, net.minecraft.src.AxisAlignedBB axisalignedbb, List<Entity> list) { }

        public override void GetEntitiesOfTypeWithinAAAB(System.Type class1, net.minecraft.src.AxisAlignedBB axisalignedbb, List<Entity> list) { }

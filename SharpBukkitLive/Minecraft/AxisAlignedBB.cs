...
namespace net.minecraft.src
{
	public class AxisAlignedBB
	{
		...
		public static net.minecraft.src.AxisAlignedBB GetBoundingBox(double d, double d1, 
			double d2, double d3, double d4, double d5)
		{
			return new net.minecraft.src.AxisAlignedBB(d, d1, d2, d3, d4, d5);
		}
		...
		public static net.minecraft.src.AxisAlignedBB GetBoundingBoxFromPool(double d, double
			 d1, double d2, double d3, double d4, double d5)
		{
			if (numBoundingBoxesInUse >= boundingBoxes.Count)
			{
				boundingBoxes.Add(GetBoundingBox(0.0D, 0.0D, 0.0D, 0.0D, 0.0D, 0.0D));
			}
			return ((net.minecraft.src.AxisAlignedBB)boundingBoxes[numBoundingBoxesInUse++]).
				SetBounds(d, d1, d2, d3, d4, d5);
		}

		private AxisAlignedBB(double d, double d1, double d2, double d3, double d4, double
			 d5)
		{
			minX = d;
			minY = d1;
		...
		public virtual net.minecraft.src.AxisAlignedBB SetBounds(double d, double d1, double
			 d2, double d3, double d4, double d5)
		{
			minX = d;
			minY = d1;
			minZ = d2;
		...
		public virtual net.minecraft.src.AxisAlignedBB AddCoord(double d, double d1, double
			 d2)
		{
			double d3 = minX;
			double d4 = minY;
		...
		public virtual net.minecraft.src.AxisAlignedBB Expand(double d, double d1, double
			 d2)
		{
			double d3 = minX - d;
			double d4 = minY - d1;
		...
		public virtual net.minecraft.src.AxisAlignedBB GetOffsetBoundingBox(double d, double
			 d1, double d2)
		{
			return GetBoundingBoxFromPool(minX + d, minY + d1, minZ + d2, maxX + d, maxY + d1
				, maxZ + d2);
		}

		public virtual double CalculateXOffset(net.minecraft.src.AxisAlignedBB axisalignedbb
			, double d)
		{
		...
		public virtual double CalculateYOffset(net.minecraft.src.AxisAlignedBB axisalignedbb
			, double d)
		{
		...
		public virtual double CalculateZOffset(net.minecraft.src.AxisAlignedBB axisalignedbb
			, double d)
		{
			if (axisalignedbb.maxX <= minX || axisalignedbb.minX >= maxX)
			{
		...
		public virtual bool IntersectsWith(net.minecraft.src.AxisAlignedBB axisalignedbb)
		{
			if (axisalignedbb.maxX <= minX || axisalignedbb.minX >= maxX)
			{
				return false;
		...
		public virtual net.minecraft.src.AxisAlignedBB Offset(double d, double d1, double
			 d2)
		{
			minX += d;
			minY += d1;
		...
		public virtual net.minecraft.src.AxisAlignedBB GetInsetBoundingBox(double d, double
			 d1, double d2)
		{
			double d3 = minX + d;
			double d4 = minY + d1;
		...
		public virtual net.minecraft.src.AxisAlignedBB Copy()
		{
		...
		private bool IsVecInYZ(net.minecraft.src.Vec3D vec3d)
		{
			if (vec3d == null)
			{
				return false;
		...
		private bool IsVecInXY(net.minecraft.src.Vec3D vec3d)
		{
			if (vec3d == null)
			{
				return false;
		...
		public virtual void SetBB(net.minecraft.src.AxisAlignedBB axisalignedbb)
		{
		...
		{
			return (new java.lang.StringBuilder()).Append("box[").Append(minX).Append(", ").Append
				(minY).Append(", ").Append(minZ).Append(" -> ").Append(maxX).Append(", ").Append

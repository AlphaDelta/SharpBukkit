...
namespace net.minecraft.src
{
	public class Teleporter
	{
		...
		public virtual void SetExitLocation(net.minecraft.src.World world, net.minecraft.src.Entity
			 entity)
		{
...
label1_break: ;
				...
				for (int i5 = -1; i5 <= 1; i5++)
				{
					for (int i6 = 1; i6 < 3; i6++)
					{
						for (int j7 = -1; j7 < 3; j7++)
						{
							...
							bool flag = j7 < 0;
							world.SetBlockWithNotify(k8, l9, i11, flag ? net.minecraft.src.Block.obsidian.blockID
								 : 0);
						}
					}
				}
			...
			for (int j5 = 0; j5 < 4; j5++)
			{
				...
				for (int j6 = 0; j6 < 4; j6++)
				{
					for (int k7 = -1; k7 < 4; k7++)
					{
						...
						world.SetBlockWithNotify(l8, i10, j11, flag1 ? net.minecraft.src.Block.obsidian.blockID
		...
		private SharpBukkitLive.SharpBukkit.SharpRandom field_28117_a;
	}
}

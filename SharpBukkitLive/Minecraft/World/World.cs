...
namespace net.minecraft.src
{
    public class World : net.minecraft.src.IBlockAccess
    {
             ...
             i1)
        {
            ...
            if (block == net.minecraft.src.Block.WATER || block == net.minecraft.src.Block
                .STATIONARY_WATER || block == net.minecraft.src.Block.LAVA || block == net.minecraft.src.Block
                .STATIONARY_LAVA || block == net.minecraft.src.Block.FIRE || block == net.minecraft.src.Block
                .SNOW)
            {
                block = null;
            }

...
{
	public class WorldGenForest : net.minecraft.src.WorldGenerator
	{
			...
			, int i, int j, int k)
		{
				...
				for (int k3 = i - i3; k3 <= i + i3; k3++)
				{
					...
					for (int i4 = k - i3; i4 <= k + i3; i4++)
					{
						...
						if ((System.Math.Abs(l3) != i3 || System.Math.Abs(j4) != i3 || random.Next(2) 
							...
							, k1, i4)])
						{
							world.SetBlockAndMetadata(k3, k1, i4, net.minecraft.src.Block.leaves.blockID, 2);
						}
					}
				}
			}
			for (int l1 = 0; l1 < l; l1++)
			{
				...
				{
					world.SetBlockAndMetadata(i, j + l1, k, net.minecraft.src.Block.wood.blockID, 2);
				}
			}
			return true;
		}

...
namespace net.minecraft.src
{
	...
	{
		public WorldManager(net.minecraft.server.MinecraftServer minecraftserver, net.minecraft.src.WorldServer
			 worldserver)
		{
		...
		public virtual void PlaySound(string s, double d, double d1, double d2, float f, 
			float f1)
		{
		}

		public virtual void MarkBlockRangeNeedsUpdate(int i, int j, int k, int l, int i1, 
			int j1)
		{
		}
		...
		{
			mcServer.configManager.MarkBlockNeedsUpdate(i, j, k, field_28134_b.worldProvider.
				worldType);
		}
		...
		public virtual void DoNothingWithTileEntity(int i, int j, int k, net.minecraft.src.TileEntity
			 tileentity)
		{
			mcServer.configManager.SentTileEntityToPlayer(i, j, k, tileentity);
		}

		public virtual void Func_28133_a(net.minecraft.src.EntityPlayer entityplayer, int
			 i, int j, int k, int l, int i1)
		{
			mcServer.configManager.Func_28171_a(entityplayer, j, k, l, 64D, field_28134_b.worldProvider
				.worldType, new net.minecraft.src.Packet61DoorChange(i, j, k, l, i1));
		}

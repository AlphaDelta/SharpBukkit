...
namespace net.minecraft.src
{
	public class WorldChunkManager
	{
		...
		public WorldChunkManager(net.minecraft.src.World world)
		{
			...
			field_4255_e = new net.minecraft.src.NoiseGeneratorOctaves2(new SharpBukkitLive.SharpBukkit.SharpRandom(
				world.GetRandomSeed() * 9871L), 4);
			field_4254_f = new net.minecraft.src.NoiseGeneratorOctaves2(new SharpBukkitLive.SharpBukkit.SharpRandom(
				world.GetRandomSeed() * 39811L), 4);
			field_4253_g = new net.minecraft.src.NoiseGeneratorOctaves2(new SharpBukkitLive.SharpBukkit.SharpRandom(
				world.GetRandomSeed() * unchecked((long)(0x84a59L))), 2);
		}

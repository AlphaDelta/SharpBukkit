...
namespace net.minecraft.src
{
	public class ItemSign : net.minecraft.src.Item
	{
			 ...
			 entityplayer, net.minecraft.src.World world, int i, int j, int k, int l)
		{
			...
			if (l == 1)
			{
				world.SetBlockAndMetadataWithNotify(i, j, k, net.minecraft.src.Block.signPost.blockID
					, net.minecraft.src.MathHelper.Floor_double((double)(((entityplayer.rotationYaw 
					+ 180F) * 16F) / 360F) + 0.5D) & unchecked((int)(0xf)));
			}
			else
			{
				world.SetBlockAndMetadataWithNotify(i, j, k, net.minecraft.src.Block.signWall.blockID
					, l);
			}
			itemstack.stackSize--;

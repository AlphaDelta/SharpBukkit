					...
					if (trackedEntity is net.minecraft.src.EntityPlayer)
					{
						...
						if (entityplayer.Func_22057_E())
						{
							entityplayermp.playerNetServerHandler.SendPacket(new net.minecraft.src.Packet17Sleep
								(trackedEntity, 0, net.minecraft.src.MathHelper.Floor_double(trackedEntity.posX)
								, net.minecraft.src.MathHelper.Floor_double(trackedEntity.posY), net.minecraft.src.MathHelper
								.Floor_double(trackedEntity.posZ)));
						}
					}
				}
			}

...
namespace net.minecraft.src
{
    public class EntityTracker
    {
        ...
        [MethodImpl(MethodImplOptions.Synchronized)] // CRAFTBUKKIT
        public virtual void TrackEntity(net.minecraft.src.Entity entity, int i, int j, bool flag)
        {
            ...
            {
                //throw new System.InvalidOperationException("Entity is already tracked!"); // CRAFTBUKKIT -- Removed
            }
            else
            {
                net.minecraft.src.EntityTrackerEntry entitytrackerentry = new net.minecraft.src.EntityTrackerEntry(entity, i, j, flag);
                trackedEntitySet.Add(entitytrackerentry);
                trackedEntityHashTable.AddKey(entity.entityId, entitytrackerentry);
                entitytrackerentry.UpdatePlayerEntities(world.playerEntities); // CRAFTBUKKIT
            }
        }
        ...
        private World world; // CRAFTBUKKIT -- Int -> World
    }
}

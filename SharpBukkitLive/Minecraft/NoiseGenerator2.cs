...
namespace net.minecraft.src
{
	public class NoiseGenerator2
	{
		...
		public NoiseGenerator2(SharpBukkitLive.SharpBukkit.SharpRandom random)
		{
		...
		public virtual void Func_4115_a(double[] ad, double d, double d1, int i, int j, double
			 d2, double d3, double d4)
		{
			int k = 0;
			for (int l = 0; l < i; l++)
			{
		...
		private static int[][] field_4317_d = new int[][] { new int[] { 1, 1, 0 }, new int[
			] { -1, 1, 0 }, new int[] { 1, -1, 0 }, new int[] { -1, -1, 0 }, new int[] { 1, 
			0, 1 }, new int[] { -1, 0, 1 }, new int[] { 1, 0, -1 }, new int[] { -1, 0, -1 }, 
			new int[] { 0, 1, 1 }, new int[] { 0, -1, 1 }, new int[] { 0, 1, -1 }, new int[]
			 { 0, -1, -1 } };
		...
		private static readonly double field_4315_f = 0.5D * (System.Math.Sqrt(3D) - 1.0D
			);

		private static readonly double field_4314_g = (3D - System.Math.Sqrt(3D)) / 6D;
	}
}

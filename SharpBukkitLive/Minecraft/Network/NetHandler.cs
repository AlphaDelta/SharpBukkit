...
namespace net.minecraft.src
{
	public abstract class NetHandler
	{
		...
		public virtual void HandleKickDisconnect(net.minecraft.src.Packet255KickDisconnect
		...
		public virtual void HandleMultiBlockChange(net.minecraft.src.Packet52MultiBlockChange
		...
		public virtual void HandleNamedEntitySpawn(net.minecraft.src.Packet20NamedEntitySpawn
		...
		public virtual void HandleEntityTeleport(net.minecraft.src.Packet34EntityTeleport
		...
		public virtual void HandleBlockItemSwitch(net.minecraft.src.Packet16BlockItemSwitch
		...
		public virtual void Func_21001_a(net.minecraft.src.Packet19EntityAction packet19entityaction
			)
		{
		...
		public virtual void Func_6002_a(net.minecraft.src.Packet28EntityVelocity packet28entityvelocity
			)
		{
			RegisterPacket(packet28entityvelocity);
		}

		public virtual void Func_21002_a(net.minecraft.src.Packet40EntityMetadata packet40entitymetadata
			)
		{
			RegisterPacket(packet40entitymetadata);
		}

		public virtual void Func_6003_a(net.minecraft.src.Packet39AttachEntity packet39attachentity
			)
		{
			RegisterPacket(packet39attachentity);
		}

		public virtual void Func_6006_a(net.minecraft.src.Packet7UseEntity packet7useentity
			)
		{
			RegisterPacket(packet7useentity);
		}

		public virtual void Func_9001_a(net.minecraft.src.Packet38EntityStatus packet38entitystatus
			)
		{
		...
		public virtual void Func_12001_a(net.minecraft.src.Packet60Explosion packet60explosion
			)
		{
			RegisterPacket(packet60explosion);
		}

		public virtual void Func_20004_a(net.minecraft.src.Packet100OpenWindow packet100openwindow
			)
		{
			RegisterPacket(packet100openwindow);
		}

		public virtual void HandleCraftingGuiClosedPacked(net.minecraft.src.Packet101CloseWindow
			 packet101closewindow)
		{
			RegisterPacket(packet101closewindow);
		}

		public virtual void Func_20007_a(net.minecraft.src.Packet102WindowClick packet102windowclick
			)
		{
			RegisterPacket(packet102windowclick);
		}

		public virtual void Func_20003_a(net.minecraft.src.Packet103SetSlot packet103setslot
			)
		{
			RegisterPacket(packet103setslot);
		}

		public virtual void Func_20001_a(net.minecraft.src.Packet104WindowItems packet104windowitems
			)
		{
		...
		public virtual void Func_20002_a(net.minecraft.src.Packet105UpdateProgressbar packet105updateprogressbar
			)
		{
			RegisterPacket(packet105updateprogressbar);
		}

		public virtual void HandlePlayerInventory(net.minecraft.src.Packet5PlayerInventory
			 packet5playerinventory)
		{
			RegisterPacket(packet5playerinventory);
		}

		public virtual void Func_20008_a(net.minecraft.src.Packet106Transaction packet106transaction
			)
		{
			RegisterPacket(packet106transaction);
		}

		public virtual void Func_21003_a(net.minecraft.src.Packet25EntityPainting packet25entitypainting
			)
		{
			RegisterPacket(packet25entitypainting);
		}

		public virtual void Func_21004_a(net.minecraft.src.Packet54PlayNoteBlock packet54playnoteblock
			)
		{
			RegisterPacket(packet54playnoteblock);
		}

		public virtual void Func_27001_a(net.minecraft.src.Packet200Statistic packet200statistic
			)
		{
			RegisterPacket(packet200statistic);
		}

		public virtual void Func_22002_a(net.minecraft.src.Packet17Sleep packet17sleep)
		{
		...
		public virtual void Func_25001_a(net.minecraft.src.Packet70Bed packet70bed)
		{
			RegisterPacket(packet70bed);
		}

		public virtual void Func_27002_a(net.minecraft.src.Packet71Weather packet71weather
			)
		{
			RegisterPacket(packet71weather);
		}

		public virtual void Func_28001_a(net.minecraft.src.Packet131MapData packet131mapdata
			)
		{
			RegisterPacket(packet131mapdata);
		}

		public virtual void Func_28002_a(net.minecraft.src.Packet61DoorChange packet61doorchange
			)
		{
